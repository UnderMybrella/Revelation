...
object VillainTraits {
    @RevelationTable("immortality scheme", recommendedRoll = "1d4", category = "Villain's Scheme")
    ...
    @RevelationTable("influence scheme", recommendedRoll = "1d4", category = "Villain's Scheme")
    ...
    @RevelationTable("magic scheme", recommendedRoll = "1d6", category = "Villain's Scheme")
    ...
    @RevelationTable("mayhem scheme", recommendedRoll = "1d6", category = "Villain's Scheme")
    ...
    @RevelationTable("passion scheme", recommendedRoll = "1d4", category = "Villain's Scheme")
    ...
    @RevelationTable("power scheme", recommendedRoll = "1d4", category = "Villain's Scheme")
    ...
    @RevelationTable("revenge scheme", recommendedRoll = "1d4", category = "Villain's Scheme")
    ...
    @RevelationTable("wealth scheme", recommendedRoll = "1d4", category = "Villain's Scheme")
    ...
    @RevelationTable("villain scheme", recommendedRoll = "1d8", category = "Villains")
    val SCHEMES = mapOf(
    ...
    @RevelationTable("agricultural devastation method", recommendedRoll = "1d4", category = "Villain's Methods")
    ...
    @RevelationTable("captivity method", "coercion method", "captivity or coercion method", recommendedRoll = "1d10", category = "Villain's Methods")
    ...
    @RevelationTable("confidence scam method", recommendedRoll = "1d6", category = "Villain's Methods")
    ...
    @RevelationTable("defamation method", recommendedRoll = "1d4", category = "Villain's Methods")
    ...
    @RevelationTable("execution method", recommendedRoll = "1d8", category = "Villain's Methods")
    ...
    @RevelationTable("magical mayhem method", recommendedRoll = "1d8", category = "Villain's Methods")
    ...
    @RevelationTable("murder method", recommendedRoll = "1d10", category = "Villain's Methods")
    ...
    @RevelationTable("political method", recommendedRoll = "1d6", category = "Villain's Methods")
    ...
    @RevelationTable("religion method", recommendedRoll = "1d4", category = "Villain's Methods")
    ...
    @RevelationTable("theft method", "property crime method", "theft or property crime method", recommendedRoll = "1d10", category = "Villain's Methods")
    ...
    @RevelationTable("torture method", recommendedRoll = "1d6", category = "Villain's Methods")
    ...
    @RevelationTable("vice method", recommendedRoll = "1d4", category = "Villain's Methods")
    ...
    @RevelationTable("warfare method", recommendedRoll = "1d6", category = "Villain's Methods")
    ...
    @RevelationTable("villain method", "villain methods", recommendedRoll = "1d20", category = "Villains")
    ...
    @RevelationTable("villain weakness", "villain weaknesses", recommendedRoll = "1d8", category = "Villains")
